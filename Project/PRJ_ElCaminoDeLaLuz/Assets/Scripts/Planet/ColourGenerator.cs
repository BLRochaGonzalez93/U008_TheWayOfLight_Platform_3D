...
public class ColourGenerator
{
    ...
    public float BiomePercentFromPoint(Vector3 poinOnUnitSphere)
    {
        float heightPercent = (poinOnUnitSphere.y + 1) / 2f;
        heightPercent += (biomeNoiseFilter.Evaluate(poinOnUnitSphere) - settings.biomeColourSettings.noiseOffset) * settings.biomeColourSettings.noiseStrength;
        float biomeIndex = 0;
